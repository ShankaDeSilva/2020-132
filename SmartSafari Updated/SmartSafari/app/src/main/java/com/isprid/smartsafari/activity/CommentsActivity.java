...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.mainRecViewCm);
        pbComment = (ProgressBar) findViewById(R.id.pbComment);
        final ImageView ivFilter = (ImageView) findViewById(R.id.ivFilter);
        txtCommentCount = (TextView) findViewById(R.id.txtCommentCount);
        edtComment = (EditText) findViewById(R.id.edt_comment);
        ImageView ivAddComment = (ImageView) findViewById(R.id.ivAddComment);
    ...
    private void submitUserComment(final String commentText, final float userRate) {
        final String userName = pref.getEncyptedPrefsValue(Constant.NAME);
        final String userId = pref.getEncyptedPrefsValue(Constant.UUID);
